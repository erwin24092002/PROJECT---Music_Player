...
namespace Music_Player
{
    ...
    public class MySongs
    {
        ...
        {
            Songs = new DataTable();
            Songs.Columns.Add("id", typeof(string));
            ...
            Songs.Rows.Add("01", "Waiting For You", "MONO", "Nguyễn Việt Hoàng", "VPop", 4, "18/08/2022");
            Songs.Rows.Add("02", "Waiting For Love", "Sten Elfstrom, Ingrid Wallin", "Sebastian Ringler", "USUK", 4, "26/06/2015");
            Songs.Rows.Add("03", "Hào Khí Việt Nam", "Phan Đinh Tùng", "Phan Đinh Tùng", "VPop", 5, "07/08/2021");
            Songs.Rows.Add("04", "Only Love", "Ben Howard", "Ben Howard", "USUK", 3, "1/8/2016");
            Songs.Rows.Add("05", "Way Back Home", "SHAUN", "SHAUN", "KPop", 3, "04/01/2019");
            Songs.Rows.Add("06", "Home", "Michael Bublé", "Michael Bublé", "USUK", 2, "27/08/2009");
            Songs.Rows.Add("07", "Easy On Me", "Adele", "Adele", "USUK", 2, "19/11/2021");
            Songs.Rows.Add("08", "Hãy Trao Cho Anh", "Sơn Tùng MTP", "Sơn Tùng MTP", "VPop", 4, "01/07/2019");
            Songs.Rows.Add("09", "Như Ngày Hôm Qua", "Sơn Tùng MTP", "Sơn Tùng MTP", "VPop", 5, "09/07/2022");
            ...
            Songs.Rows.Add("13", "We Dont Talk Anymore", "Charlie Puth", "Charlie Puth", "USUK", 3, "03/08/2016");
            ...
            Songs.Rows.Add("20", "Say You Wont Let Go", "James Arthur", "James Arthur", "USUK", 3, "09/09/2016");
